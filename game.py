...
# le all_sprite permet de représenter tous les objets à l'écran au momment du blit  
...
class Vaisseau(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\L3\projets_python\images programmation\images python\spaceshift.png").convert_alpha()
...
class Missile(pygame.sprite.Sprite):
    ...
    def __init__(self, center_Missile):
            ...
            self.surf = pygame.image.load("C:/L3/projets_python/images programmation/images python/basket-ball.png").convert_alpha()
            self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Ennemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\L3\projets_python\images programmation\images python\ennemy.png").convert_alpha()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
        self.rect = self.surf.get_rect(
            center = (
                850,
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, center_vaisseau):
        ...
        self.surf = pygame.image.load("C:\L3\projets_python\images programmation\images python\collision.png").convert_alpha()
        self.surf.set_colorkey((255,255,255), RLEACCEL)
...
class Etoile(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\L3\projets_python\images programmation\images python\étoile.png").convert_alpha()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
        self.rect = self.surf.get_rect(
            center = (850,
            random.randint(0, 600)
